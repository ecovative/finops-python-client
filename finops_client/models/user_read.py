...
class UserRead(BaseModel):
    ...
    app_role: Optional[AppRole] = Field(default=None, alias="AppRole")
    last_time_logged_in: Optional[datetime] = Field(default=None, alias="LastTimeLoggedIn")
    ...
    subscriptions: Optional[List[SubscriptionBase]] = Field(default=None, alias="Subscriptions")
    __properties: ClassVar[List[str]] = ["UserEmail", "AppRole", "LastTimeLoggedIn", "DbCreatedBy", "DbTimeCreated", "DbTimeModified", "Subscriptions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if app_role (nullable) is None
        # and model_fields_set contains the field
        if self.app_role is None and "app_role" in self.model_fields_set:
            _dict['AppRole'] = None

        # set to None if last_time_logged_in (nullable) is None
        # and model_fields_set contains the field
        if self.last_time_logged_in is None and "last_time_logged_in" in self.model_fields_set:
            _dict['LastTimeLoggedIn'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AppRole": obj.get("AppRole"),
            "LastTimeLoggedIn": obj.get("LastTimeLoggedIn"),
            "DbCreatedBy": obj.get("DbCreatedBy"),
            "DbTimeCreated": obj.get("DbTimeCreated"),
            "DbTimeModified": obj.get("DbTimeModified"),
            "Subscriptions": [SubscriptionBase.from_dict(_item) for _item in obj["Subscriptions"]] if obj.get("Subscriptions") is not None else None
        })
        return _obj
