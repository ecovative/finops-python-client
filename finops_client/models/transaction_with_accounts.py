...
class TransactionWithAccounts(BaseModel):
    """
    ...
    fq_txn_link_key: Optional[StrictStr] = Field(default=None, alias="FQTxnLinkKey")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if fq_txn_link_key (nullable) is None
        # and model_fields_set contains the field
        if self.fq_txn_link_key is None and "fq_txn_link_key" in self.model_fields_set:
            _dict['FQTxnLinkKey'] = None
