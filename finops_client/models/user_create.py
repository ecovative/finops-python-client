...
class UserCreate(BaseModel):
    ...
    db_created_by: StrictStr = Field(alias="DbCreatedBy")
    ...
    __properties: ClassVar[List[str]] = ["UserEmail", "AppRole", "LastTimeLoggedIn", "DbCreatedBy", "DbTimeCreated", "DbTimeModified"]
