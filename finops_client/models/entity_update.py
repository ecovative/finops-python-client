...
class EntityUpdate(BaseModel):
    ...
    type: Optional[EntityType] = Field(default=None, alias="Type")
    ...
    __properties: ClassVar[List[str]] = ["ListID", "TimeModified", "EditSequence", "Name", "FullName", "IsActive", "ParentRefListID", "Sublevel", "ClassRefListID", "CompanyName", "Type", "TimeCreated", "Source", "DbCreatedBy", "DbTimeCreated", "DbTimeModified"]
