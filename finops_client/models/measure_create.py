...
class MeasureCreate(BaseModel):
    ...
    account_ref_list_id: StrictStr = Field(alias="AccountRefListID")
    ...
    __properties: ClassVar[List[str]] = ["MeasureID", "AccountRefListID", "ClassRefListID", "Period", "MeasureType", "Currency", "Amount", "Source", "DbCreatedBy", "DbTimeCreated", "DbTimeModified"]
