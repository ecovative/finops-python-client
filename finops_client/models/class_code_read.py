...
class ClassCodeRead(BaseModel):
    ...
    parent_class_code: Optional[ClassCodeBase] = Field(default=None, alias="ParentClassCode")
    child_class_codes: Optional[List[ClassCodeBase]] = Field(default=None, alias="ChildClassCodes")
    __properties: ClassVar[List[str]] = ["ListID", "TimeModified", "EditSequence", "Name", "FullName", "IsActive", "ParentRefListID", "ParentRefFullName", "Sublevel", "TimeCreated", "Source", "DbCreatedBy", "DbTimeCreated", "DbTimeModified", "ParentClassCode", "ChildClassCodes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of parent_class_code
        if self.parent_class_code:
            _dict['ParentClassCode'] = self.parent_class_code.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in child_class_codes (list)
        _items = []
        if self.child_class_codes:
            for _item_child_class_codes in self.child_class_codes:
                if _item_child_class_codes:
                    _items.append(_item_child_class_codes.to_dict())
            _dict['ChildClassCodes'] = _items
        ...
        # set to None if parent_class_code (nullable) is None
        # and model_fields_set contains the field
        if self.parent_class_code is None and "parent_class_code" in self.model_fields_set:
            _dict['ParentClassCode'] = None

        # set to None if child_class_codes (nullable) is None
        # and model_fields_set contains the field
        if self.child_class_codes is None and "child_class_codes" in self.model_fields_set:
            _dict['ChildClassCodes'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ParentClassCode": ClassCodeBase.from_dict(obj["ParentClassCode"]) if obj.get("ParentClassCode") is not None else None,
            "ChildClassCodes": [ClassCodeBase.from_dict(_item) for _item in obj["ChildClassCodes"]] if obj.get("ChildClassCodes") is not None else None
        })
        return _obj
