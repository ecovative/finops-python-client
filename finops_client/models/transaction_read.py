...
class TransactionRead(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Entity": EntityBase.from_dict(obj["Entity"]) if obj.get("Entity") is not None else None,
