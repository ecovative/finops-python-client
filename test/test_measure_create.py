...
class TestMeasureCreate(unittest.TestCase):
    """MeasureCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeasureCreate:
        """Test MeasureCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeasureCreate`
        """
        model = MeasureCreate()
        if include_optional:
