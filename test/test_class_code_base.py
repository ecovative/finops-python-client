...
class TestClassCodeBase(unittest.TestCase):
    """ClassCodeBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClassCodeBase:
        """Test ClassCodeBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClassCodeBase`
        """
        model = ClassCodeBase()
        if include_optional:
            return ClassCodeBase(
                list_id = '',
