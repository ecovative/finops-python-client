...
class TestAccountBase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccountBase:
        """Test AccountBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountBase`
        """
        model = AccountBase()
        if include_optional:
            return AccountBase(
