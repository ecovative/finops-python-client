...
class TestMeasureUpdate(unittest.TestCase):
    """MeasureUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeasureUpdate:
        """Test MeasureUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeasureUpdate`
        """
        model = MeasureUpdate()
        if include_optional:
