...
class TestReadAccountsAccountsGet200ResponseInner(unittest.TestCase):
    """ReadAccountsAccountsGet200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadAccountsAccountsGet200ResponseInner:
        """Test ReadAccountsAccountsGet200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadAccountsAccountsGet200ResponseInner`
        """
        model = ReadAccountsAccountsGet200ResponseInner()
        if include_optional:
            return ReadAccountsAccountsGet200ResponseInner(
                list_id = '',
    ...
    def testReadAccountsAccountsGet200ResponseInner(self):
        """Test ReadAccountsAccountsGet200ResponseInner"""
