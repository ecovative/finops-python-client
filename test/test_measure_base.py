...
class TestMeasureBase(unittest.TestCase):
    """MeasureBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeasureBase:
        """Test MeasureBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeasureBase`
        """
        model = MeasureBase()
        if include_optional:
            return MeasureBase(
