...
class TestSubscriptionBase(unittest.TestCase):
    """SubscriptionBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionBase:
        """Test SubscriptionBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionBase`
        """
