...
class TestSubscriptionRead(unittest.TestCase):
    """SubscriptionRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionRead:
        """Test SubscriptionRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionRead`
        """
        model = SubscriptionRead()
        if include_optional:
